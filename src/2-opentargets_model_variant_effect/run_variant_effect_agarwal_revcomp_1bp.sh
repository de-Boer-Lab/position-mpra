...
BASE_SCRIPT_PATH="/scratch/st-cdeboer-1/sambina/position_mpra/src/opentargets_model_variant_effect/open_targets_offset_agarwal_revcomp_1bp.py"
...
for key in "${!models[@]}"; do
    ...
    output_path="$BASE_OUTPUT_DIR/${key}_revcomp_1bp.csv.gz"
