...
BASE_SCRIPT_PATH="/scratch/st-cdeboer-1/sambina/position_mpra/src/2-opentargets_model_variant_effect/open_targets_offset_gosai_ref_alt_activity.py"
BASE_MODEL_DIR="/scratch/st-cdeboer-1/sambina"
BASE_OUTPUT_DIR="/scratch/st-cdeboer-1/sambina/position_mpra/outputs/2-opentargets_model_variant_effect/gosai"
