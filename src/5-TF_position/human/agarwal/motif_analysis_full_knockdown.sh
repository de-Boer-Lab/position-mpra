#!/bin/bash
#SBATCH --job-name=motif_fk_humans
...
python /scratch/st-cdeboer-1/sambina/position_mpra/src/TF_position/human/agarwal/random_sequence_knockdown_rc.py &
python /scratch/st-cdeboer-1/sambina/position_mpra/src/TF_position/human/agarwal/random_sequence_knockdown.py &
