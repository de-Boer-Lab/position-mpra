...
def train_predict():
    ...
    test_df = pd.read_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/human/k562_regulator_knockout_agarwal_rc.csv")
    ...
    test_df.to_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/human/predicted_k562_regulator_knockout_agarwal_rc.csv", index=False)
    print(test_df.head())
