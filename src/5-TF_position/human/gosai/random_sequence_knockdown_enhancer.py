...
def train_predict():
    ...
    test_df = pd.read_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/human/enhancer/k562_regulator_knockout_enhancer.txt", sep="\t")
    ...
    test_df.to_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/human/enhancer/predicted_k562_regulator_knockout_gosai_enhancer.txt", sep="\t", index=False)
    print(test_df.head())
