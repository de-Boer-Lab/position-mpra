...
def train_predict():
    ...
    test_df = pd.read_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/5-TFs_position/human/k562_regulator_knockout_gosai_rc.csv.gz", compression="gzip")
    ...
    test_df.to_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/5-TFs_position/human/predicted_k562_regulator_knockout_gosai_Ns_rc.csv.gz", compression="gzip", index=False)
    print(test_df.head())
