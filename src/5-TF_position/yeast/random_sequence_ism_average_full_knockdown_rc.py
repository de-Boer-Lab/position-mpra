...
ref_df = pd.read_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/yeast/all_yeast_variants_full_knockout_rc.csv")
...
result_ref.to_csv("/scratch/st-cdeboer-1/sambina/position_mpra/outputs/TFs_position/yeast/predicted_all_yeast_full_knockout_rc.csv")
