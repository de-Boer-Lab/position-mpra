...
CUDA_DEVICE_ID = 0
lr = 0.005
ref_df = pd.read_csv("/scratch/st-cdeboer-1/sambina/position_variant_effect/paper_analysis/figure_3/yeast_motifs/output/all_yeast_variants_full_knockout_rc.csv")
...
result_ref.to_csv("/scratch/st-cdeboer-1/sambina/position_variant_effect/paper_analysis/figure_3/yeast_motifs/output/predicted_all_yeast_full_knockout_rc.csv")
